...
**[React Todo List]** is a Single Page App (SPA) that allows users to:
...
- [Live Demo Link](https://mperezbazan.github.io/react-todo-project/)
...
```sh
  cd my-folder
  git clone git@github.com:mperezbazan/react-todo-project.git
```
